...
Reproduced from the canonical version available at:
https://github.com/aws-samples/amazon-textract-response-parser

Copyright Amazon 2020, licensed under Apache-2.0. For full details, see:
https://github.com/aws-samples/amazon-textract-response-parser/blob/master/LICENSE
"""
